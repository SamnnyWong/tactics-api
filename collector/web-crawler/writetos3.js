...
export const main = async (event, context) => {
    var bucketName = "davidtestlist";//change to corresponding bucket name
    var paramlist = {
        Bucket: bucketName,
        Prefix:"10-22"// can change 10.22 to current patch version
    };
    ...
    var fileName = 'v'+ currentVersion.toString() +'.json';
    var keyName = getKeyName("10-22", fileName);// can change 10.22 to current patch version
